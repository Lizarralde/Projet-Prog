 ...
 * utilis&eacute;es. On y d&eacute;finit les diff&eacute;rentes qu'ont en
 * communt les mat&eacute;riels composant le stock
 * 
 * @author Falou Seck
...
public class Article implements Serializable {
    ...
    private Etat etat;
    // L'intégrité est une valeur inférieure ou égale à 100 montrant la
    // qualité de l'article en question.
    ...
    public Article(String marque, String modele, String caracteristiques) {
        ...
        this.idArticle = "AR";
        // L'identifiant de l'article contient les 3 premières lettres de la
        // marque
    ...
    /**
     * Cette m&eacute;thode renvoie une description compl&eacute;te d'un
     * article, indiquant l'&eacute;tat de toutes les propri&eacute;t&eacute;s
     * d'un article.
     * 
    ...
    /**
     * Cette m&eacute;thode met &egrave; jour l'&eacute;tat d'un article du
     * stock
     * 
     * @param state
     *            indique le nouvel &eacute;tat de l'article
     */
    ...
    /**
     * Ctte Cette m&eacute; renvoie les caractéristiques de l'article en
     * question.
     * 
     * @return retourne une chaine de caract&egrave;s
     **/
    ...
    /**
     * Ctte Cette m&eacute; renvoie l'identifiant de l'article en question.
     * 
     * @return retourne une chaine de caract&egrave;s
     **/
    ...
    /**
     * Ctte Cette m&eacute; renvoie l'état de l'article en question.
     * C'est-à-dire, Emprunté, Disponible, EnRéparation ou Inutilisable.
     * 
    ...
    /**
     * Ctte Cette m&eacute; renvoie le modèle de l'article en question.
     * 
     * @return retourne une chaine de caract&egrave;s
     **/
    ...
    /**
     * Ctte Cette m&eacute; détermine la date d'emprunt de l'article.
     **/
    ...
    /**
     * Ctte Cette m&eacute; détermine la date de retour de l'article en
     * question.
     **/
    ...
    /**
     * Ctte Cette m&eacute; renvoie la date d'emprunt de l'article en question.
     * 
    ...
    /**
     * Ctte Cette m&eacute; renvoie la date de retour d'emprunt de l'article en
     * question.
     * 
     * @return Elle retourne une chaine de caract&egrave;s
     **/
