...
public class Menu {
                    ...
                    if (connecte != null) {
                        ...
                        case 1:
                            if (classe.equals("gestion_stock.Emprunteur")) {
                                ...
                                System.out
                                        .println("Identifiant et/ou mot de passe incorrects");
                            }
                            break;
                        case 2:
    ...
    public static int menuPrincipal() {
        ...
        System.out
                .println("\t|                                                             |");
        System.out
                .println("\t|               1 ---> Emprunteur                             |");
        System.out
                .println("\t|                                                             |");
        System.out
                .println("\t|               2 ---> Gestionnaire                           |");
        System.out
                .println("\t|                                                             |");
        System.out
                .println("\t|               3 ----> Quitter                               |");
    ...
    public static void menuEmprunteur(Emprunteur e, Stock st,
            ListeUtilisateur lus) {
        ...
        do {
            ...
            System.out
                    .println("\t|                                                                |");
            System.out
                    .println("\t|                        MENU EMPRUNTEUR                         |");
            System.out
                    .println("\t|                                                                |");
            System.out.println("\t ____   Emprunteur connecté: "
                    + e.getPrenom() + " " + e.getNom().toUpperCase() + " ____");
            System.out
                    .println("\t|                                                                |");
            System.out
                    .println("\t|             1--> Emprunter un nouvel appareil                  |");
            System.out
                    .println("\t|                                                                |");
            System.out
                    .println("\t|             2--> Modifier mon mot de passe                     |");
            System.out
                    .println("\t|                                                                |");
            System.out
                    .println("\t|             3--> Consulter ma fiche                            |");
            System.out
                    .println("\t|                                                                |");
            System.out
                    .println("\t|             4--> Quitter                                       |");
            ...
            case 1: {
                ...
                if (st.articlesDisponibles().size() > 0) {
                    ...
                    if (ar == null)
                        ...
                        System.out
                                .println("\n\tCet article ne sera disponible que le "
                                        + ar.getDateRetour());
                } else
                    System.out
                            .println("Il n'y a aucun article disponible pour le moment.");
                break;
            }
            case 2: {
                Console console = System.console();
    ...
    public static void menuGestionnaire(Gestionnaire g, Stock st,
            ListeUtilisateur lus) {
        ...
        do {
            ...
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|                       MENU GESTIONNAIRE                      |");
            System.out
                    .println("\t|                                                              |");
            System.out.println("\t    _____ Gestionnaire connecté: "
                    + g.getPrenom() + " " + g.getNom().toUpperCase()
                    + "   ______");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              1--> Ajouter un nouveau matériel                |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              2--> Ajouter un nouvel utilisateur              |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              3--> Etat du stock                              |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              4--> Voir la fiche d'un article                 |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              5--> Liste des appareils à réparer              |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              6--> Liste des appareils en réparation          |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              7--> Réparer les appareils défectueux           |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              8--> Modifier mot de passe                      |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|              9--> Liste de tous les utilisateurs             |");
            System.out
                    .println("\t|                                                              |");
            System.out
                    .println("\t|             10--> Quitter                                    |");
            ...
            case 1: {
                do {
                    ...
                    System.out
                            .println("\t|                                                              |");
                    System.out
                            .println("\t|                       MENU Article                           |");
                    System.out
                            .println("\t|                                                              |");
                    System.out.println("\t|__Gestionnaire connexté: "
                            + g.getPrenom() + " " + g.getNom().toUpperCase()
                            + "   ________________|");
                    System.out
                            .println("\t|                                                              |");
                    ...
                    if (ch2 < 5) {
                        ...
                        case 1: {
                            ...
                            article = new Telephone(marque, modele,
                                    caracteristiques);
                            System.out
                        ...
                        case 2: {
                            ...
                            article = new Tablette(marque, modele,
                                    caracteristiques);
                            break;
                        }
                        case 3: {
                            ...
                            article = new Camera(marque, modele,
                                    caracteristiques);
                            break;
                        }
                        case 4: {
                            ...
                            article = new Casque(marque, modele,
                                    caracteristiques);
                            break;
                        }
            ...
            case 2: {
                ...
                do {
                    ...
                    System.out
                            .println("\t|                                                              |");
                    System.out
                            .println("\t|                       MENU Ajout utilisateur                 |");
                    System.out
                            .println("\t|                                                              |");
                    System.out.println("\t|__Gestionnaire connexté: "
                            + g.getPrenom() + " " + g.getNom().toUpperCase()
                    ...
                    System.out
                            .println("\t|                                                              |");
                    System.out
                            .println("\t|                 Vous voulez  ajouter?                        |");
                    System.out
                            .println("\t|                                                              |");
                    System.out
                            .println("\t|              1--> Un gestionnaire                            |");
                    System.out
                            .println("\t|                                                              |");
                    System.out
                            .println("\t|              2--> Un emprunteur                              |");
                    System.out
                            .println("\t|                                                              |");
                    System.out
                            .println("\t|              3--> Quitter                                    |");
                    ...
                    if (choix < 3) {
                        ...
                        System.out
                                .println("\nVotre mot de passe par défaut est: "
                                        + user.getMotDePasse()
                                        + ". Pensez à le modifier lors de votre prochaine connexion");
                        lus.ajouter(user);
                        try {
                            oos = new ObjectOutputStream(
                                    new BufferedOutputStream(
                    ...
                    System.out
                            .print("Voulez-vous ajouter un nouvel utilisateur [O/N]?  ");
                    rep = sc.nextLine().charAt(0);
                } while (rep != 'n' && rep != 'N');
                break;
            ...
            case 5: {
                sc.nextLine();
                System.out.println("Nombre d'articles à réparer: "
                        + st.articlesAReparer().size());
                System.out.println(st.articlesAReparer());
                break;
            }
            case 6: {
                sc.nextLine();
                System.out.println("Nombre d'articles en réparation: "
                        + st.articlesEnReparation().size());
